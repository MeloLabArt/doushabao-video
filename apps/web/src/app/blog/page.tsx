...
export const metadata: Metadata = {
	title: "Blog - Doushabao-Video",
	description:
		"Read the latest news and updates about Doushabao-Video, the free and open-source video editor.",
	openGraph: {
		title: "Blog - Doushabao-Video",
		description:
			"Read the latest news and updates about Doushabao-Video, the free and open-source video editor.",
...
export default async function BlogPage() {
  ...
  const desc = serverT("staticPages.blogDesc");
	...
	return (
		<BasePage
			title="Blog"
			description="Read the latest news and updates about Doushabao-Video, the free and open-source video editor."
		>

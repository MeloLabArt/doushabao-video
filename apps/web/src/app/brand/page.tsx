...
const ASSET_SECTIONS: AssetSection[] = [
	{
		title: "Symbol",
		description:
			"Use the symbol on its own when the Doushabao-Video name is already present nearby or space is limited.",
		cols: "2",
		assets: [
			{
...
export default function BrandPage() {
	return (
		<BasePage
			...
			description={
				<>
					Download Doushabao-Video brand assets for use in your projects.{" "}
					<Link
						href="#guidelines"
			...
			<div id="guidelines" className="flex flex-col gap-8 text-sm">
				<div className="flex flex-col gap-3">
					...
					<p className="text-muted-foreground text-base leading-relaxed">
						Doushabao-Video is open source — the code is free to use under its license.
						That license does not cover the name or logo. You can say you use
						Doushabao-Video, that your project integrates with Doushabao-Video, or that it was
						built on top of Doushabao-Video. You cannot name your product Doushabao-Video, imply
				...
				<div className="flex flex-col gap-3">
					...
					<ul className="text-muted-foreground text-base flex flex-col gap-2 leading-relaxed">
						{[
							"Using Doushabao-Video in the name of your product, service, or domain.",
							"Implying that Doushabao-Video made, sponsors, or endorses your work.",

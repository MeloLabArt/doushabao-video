...
export const metadata: Metadata = {
	title: "Roadmap - Doushabao-Video",
	description:
		"See what's coming next for Doushabao-Video - the free, open-source video editor that respects your privacy.",
	openGraph: {
		title: "Doushabao-Video Roadmap - What's Coming Next",
		description:
			"See what's coming next for Doushabao-Video - the free, open-source video editor that respects your privacy.",
		type: "website",
		images: [
